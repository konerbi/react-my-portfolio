		...
		<div className={'home-qualities-container'}>
			<div className={'qualities-box'}>
				<div className={'quality-item'}>
					...
					<div className={'quality-text'} dangerouslySetInnerHTML={CreateTextHtml(t('home.qualities.experience'))}></div>
				</div>
				<div className={'quality-item vertical'}>
					<div className={'quality-icon text-icon'}>
						{t('home.qualities.solid')}
					</div>
					<div className={'quality-text'} dangerouslySetInnerHTML={CreateTextHtml(t('home.qualities.knowledge'))}></div>
				</div>
				<div className={'quality-item'}>
				...
				<div className={'quality-item with-icon'}>
					...
					<div className={'quality-text'} dangerouslySetInnerHTML={CreateTextHtml(t('home.qualities.pixel'))}></div>
				</div>
				<div className={'quality-item wide'}>
					<div className={'quality-icon'}>
						<img src={`src/assets/images/home/team.svg`}></img>
					</div>
					<div className={'quality-text'} dangerouslySetInnerHTML={CreateTextHtml(t('home.qualities.teamplayer'))}></div>
				</div>
			</div>
		</div>
	);
